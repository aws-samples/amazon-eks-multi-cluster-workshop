...
class CdkEksC2Stack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, vpc, **kwargs) -> None:
        ...
        self.c2_cluster = eks.Cluster(self, "EKSCluster2",
        ...
        eks_role = iam.Role(self, "EKS_Node_Role2", assumed_by=iam.ServicePrincipal("ec2.amazonaws.com"),
            managed_policies=[
        ...
        self.c2_ng = self.c2_cluster.add_nodegroup_capacity("cluster2-node-group",
